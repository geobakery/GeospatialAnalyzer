...
export abstract class DbAdapterService {
  ...
  abstract bufferFeature(feature: SqlParameter, distance: SqlParameter, srid: number, quadSegs?: number): string;

  abstract getBufferJsonStructure(bufferGeometry: string, bufferDistance: string,): string;
