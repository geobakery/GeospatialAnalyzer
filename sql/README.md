...
This directory contains a Dockerfile to generate a database utility container image. It uses the same default dataset used in the docker compose dev setup. 
