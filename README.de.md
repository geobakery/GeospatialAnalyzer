...
Die empfohlene und getestete Version ist Node.js 24, auch wenn andere Versionen möglicherweise ebenfalls funktionieren.
...
(3) Konfigurieren Sie die `env.dev` (und `topic.json` falls gewünscht)
